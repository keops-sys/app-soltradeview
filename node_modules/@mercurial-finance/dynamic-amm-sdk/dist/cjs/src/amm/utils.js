...
const calculateSwapQuote = (inTokenMint, inAmountLamport, params) => {
    ...
    const sourceVaultLp = (0, vault_sdk_1.getUnmintAmount)(sourceAmountLessAdminFee, sourceVaultWithdrawableAmount, swapSourceVaultLpSupply);
