...
import { CURVE_TYPE_ACCOUNTS, ERROR, WRAPPED_SOL_MINT, PROGRAM_ID, VIRTUAL_PRICE_PRECISION, PERMISSIONLESS_AMP, STABLE_SWAP_DEFAULT_TRADE_FEE_BPS, CONSTANT_PRODUCT_DEFAULT_TRADE_FEE_BPS, } from './constants';
...
export const calculateSwapQuote = (inTokenMint, inAmountLamport, params) => {
    ...
    const sourceVaultLp = getUnmintAmount(sourceAmountLessAdminFee, sourceVaultWithdrawableAmount, swapSourceVaultLpSupply);
